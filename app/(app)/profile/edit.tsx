...
export default function EditProfileScreen() {
  ...
  useEffect(() => {
    if (userProfile) {
      ...
      // For Google sign-in users without profile, pre-fill email
      setFormData({
    ...
    <SafeAreaView style={dynamicStyles.container}>
      ...
      >
        <View style={dynamicStyles.header}>
          <TouchableOpacity
            onPress={() => {
              // For first-time profile completion, redirect to main app instead of going back
          ...
          <View style={styles.titleContainer}>
            <Text style={dynamicStyles.title}>
              {!userProfile || !userProfile.profileComplete ? 'Complete Your Profile' : 'Edit Profile'}
            </Text>
          </View>
          ...
          <View style={dynamicStyles.form}>
            ...
            <View style={dynamicStyles.profilePictureSection}>
              <View style={dynamicStyles.profilePictureContainer}>
                ...
                >
                  {localImageUri || formData.profilePicture ? (
                    <Image 
              ...
              {(localImageUri || formData.profilePicture) && !uploadingImage && (
